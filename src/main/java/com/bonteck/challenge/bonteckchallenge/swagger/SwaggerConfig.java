package com.bonteck.challenge.bonteckchallenge.swagger;
...
//        return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo(swaggerConfigProperties)).enable(Boolean.valueOf(swaggerConfigProperties.getEnabled())).select().apis(RequestHandlerSelectors.basePackage( "com.bonteck.challenge.bonteckchallenge" ))
