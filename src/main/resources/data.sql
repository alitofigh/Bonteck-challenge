...
--  INSERT INTO SERVICE (name, cost, is_Active, activation_Date) values ('SEND SMS', 15, true, current_timestamp());
--  INSERT INTO SERVICE (name, cost, is_Active, activation_Date) values ('SEND EMAIL', 10, true, current_timestamp());
--  INSERT INTO SERVICE (name, cost, is_Active, activation_Date) values ('GET WORLD NEWS', 5, true, current_timestamp());
